...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Ticker_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Ticker_t qt_meta_stringdata_Ticker = {
    {
QT_MOC_LITERAL(0, 6) // "Ticker"
...
const QMetaObject Ticker::staticMetaObject = { {
    ...
    qt_meta_stringdata_Ticker.offsetsAndSize,
    qt_meta_data_Ticker,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Ticker_t
, QtPrivate::TypeAndForceComplete<Ticker, std::true_type>
