...
QT_MOC_LITERAL(7, 13), // "pixmapUpdated"
QT_MOC_LITERAL(21, 0), // ""
QT_MOC_LITERAL(22, 6) // "pixmap"

    },
    "Drawer\0pixmapUpdated\0\0pixmap"
};
...
void Drawer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->pixmapUpdated((*reinterpret_cast< QPixmap(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Drawer::*)(QPixmap );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Drawer::pixmapUpdated)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<Drawer, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<QPixmap, std::false_type>
...
// SIGNAL 0
void Drawer::pixmapUpdated(QPixmap _t1)
{
